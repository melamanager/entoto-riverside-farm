...
export default function TasksPage() {
  ...
  // Filter tasks by role — supervisors see only tasks assigned to them
        ...
        <DialogContent className="max-w-lg">
          ...
          {selectedTask && (
            <div className="space-y-4">
              ...
              {/* Actions — only if task is not done and current user can act */}
                ...
                <>
                  ...
                  <div>
                    ...
                    <Textarea
                      ...
                      placeholder="Describe what was done, any issues encountered, or next steps…"
              ...
              {selectedTask.status === "done" && selectedTask.proofImageUrl && (
                <div>
                  ...
                  <div className="relative rounded-lg overflow-hidden border border-slate-200">
                    ...
                    <button
                      onClick={() => setPreviewUrl(selectedTask.proofImageUrl!)}
