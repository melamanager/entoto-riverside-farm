            ...
            <div className="space-y-5">
              <div>
                ...
                <div className="flex justify-between text-[10px] text-muted-foreground mt-0.5">
                  <span>More alerts (50%)</span><span>Fewer, certain alerts (95%)</span>
                </div>
              </div>
              <div>
                <div className="flex items-center justify-between mb-2">
                ...
                />
                <div className="flex justify-between text-[10px] text-muted-foreground mt-0.5">
                  <span>Alert at very dry (30%)</span><span>Alert early (70%)</span>
                </div>
              </div>
              <div>
                <div className="flex items-center justify-between mb-2">
                ...
                />
                <div className="flex justify-between text-[10px] text-muted-foreground mt-0.5">
                  <span>Alert often (30)</span><span>Alert only critical (90)</span>
                </div>
              </div>
              <div>
          ...
          <Card className="p-5">
            ...
            <div className="space-y-4">
              <div className="flex items-center justify-between p-3 rounded-lg border border-border">
                <div className="flex items-center gap-3">
                  <div className="size-8 rounded-lg bg-blue-100 dark:bg-blue-950/40 grid place-items-center"><span className="text-sm">📱</span></div>
                  <div>
              ...
              <div className="flex items-center justify-between p-3 rounded-lg border border-border">
                <div className="flex items-center gap-3">
                  <div className="size-8 rounded-lg bg-sky-100 dark:bg-sky-950/40 grid place-items-center"><span className="text-sm">✈️</span></div>
                  <div>
          ...
          <Card className="p-5">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
              ...
              <div>
                ...
                <input type="number" value={altitudeM} onChange={e => setAltitudeM(Number(e.target.value))}
                  className="w-full border border-border rounded-lg px-3 py-2 text-sm bg-card focus:outline-none focus:ring-2 focus:ring-ring" />
              </div>
              <div>
                <label className="text-xs font-semibold text-muted-foreground uppercase tracking-wide block mb-1.5">Target Yield (kg/m)</label>
                <input type="number" step={0.01} value={targetKgPerM} onChange={e => setTargetKgPerM(Number(e.target.value))}
                  className="w-full border border-border rounded-lg px-3 py-2 text-sm bg-card focus:outline-none focus:ring-2 focus:ring-ring" />
