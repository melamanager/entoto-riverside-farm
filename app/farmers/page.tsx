  ...
  return (
    <div className="p-6 md:p-8 max-w-[1400px] mx-auto space-y-6">
      <div>
        ...
        <p className="text-muted-foreground text-sm">Roles, assignments, performance & attendance</p>
      </div>
            ...
            <Card key={f.id} className="p-5">
              <div className="flex items-start gap-3 mb-3">
                <Avatar className="size-12 ring-2 ring-border">
                  <AvatarFallback className="bg-primary/15 text-primary font-semibold">{f.avatar}</AvatarFallback>
                </Avatar>
              ...
              <div className="grid grid-cols-2 gap-2 text-center pt-3 border-t border-border">
                <div>
                  <div className="text-xs text-muted-foreground flex items-center justify-center gap-1"><ListTodo className="size-3" /> Pending</div>
                  <div className="text-base font-bold text-amber-600">{pending}</div>
                </div>
                <div>
                  <div className="text-xs text-muted-foreground flex items-center justify-center gap-1"><CheckCircle2 className="size-3" /> Done</div>
                  <div className="text-base font-bold text-primary">{done}</div>
                </div>
              </div>
            </Card>
          );
