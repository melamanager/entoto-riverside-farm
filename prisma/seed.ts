...
async function main() {
  ...
  // ── 1. Farmers ──────────────────────────────────────────────────────────────
  const farmers = [
    { id: "f-001", name: "Abebe Kebede",     phone: "+251-91-122-3344", avatar: "AK", role: "farmer" as const,     performanceScore: 92, attendanceRate: 98,  joinedDate: "2025-09-15", assignedValves: ["valve-a"] as Prisma.InputJsonValue,                nationalId: "ETH-2341-A", emergencyContact: "+251-91-999-0011", dailyWage: 550, employmentType: "permanent", paymentMethod: "cash" },
    { id: "f-002", name: "Tigist Haile",     phone: "+251-91-133-4455", avatar: "TH", role: "farmer" as const,     performanceScore: 88, attendanceRate: 95,  joinedDate: "2025-10-01", assignedValves: ["valve-a"] as Prisma.InputJsonValue,                nationalId: "ETH-2342-B", emergencyContact: "+251-91-999-0022", dailyWage: 550, employmentType: "permanent", paymentMethod: "cash" },
    { id: "f-003", name: "Mulugeta Tesfaye", phone: "+251-91-144-5566", avatar: "MT", role: "farmer" as const,     performanceScore: 85, attendanceRate: 92,  joinedDate: "2025-10-10", assignedValves: ["valve-b"] as Prisma.InputJsonValue,                nationalId: "ETH-2343-C", emergencyContact: "+251-91-999-0033", dailyWage: 550, employmentType: "permanent", paymentMethod: "cash" },
    { id: "f-004", name: "Hanna Solomon",    phone: "+251-91-155-6677", avatar: "HS", role: "farmer" as const,     performanceScore: 95, attendanceRate: 99,  joinedDate: "2025-09-20", assignedValves: ["valve-b"] as Prisma.InputJsonValue,                nationalId: "ETH-2344-D", emergencyContact: "+251-91-999-0044", dailyWage: 580, employmentType: "permanent", paymentMethod: "cash" },
    { id: "f-005", name: "Dawit Bekele",     phone: "+251-91-166-7788", avatar: "DB", role: "farmer" as const,     performanceScore: 78, attendanceRate: 88,  joinedDate: "2025-11-01", assignedValves: ["valve-c"] as Prisma.InputJsonValue,                nationalId: "ETH-2345-E", emergencyContact: "+251-91-999-0055", dailyWage: 550, employmentType: "permanent", paymentMethod: "cash" },
    { id: "f-006", name: "Selam Girma",      phone: "+251-91-177-8899", avatar: "SG", role: "supervisor" as const, performanceScore: 94, attendanceRate: 97,  joinedDate: "2025-09-01", assignedValves: ["valve-a","valve-b"] as Prisma.InputJsonValue,      nationalId: "ETH-2346-F", dailyWage: 920, employmentType: "permanent", paymentMethod: "cash" },
    { id: "f-007", name: "Yonas Alemu",      phone: "+251-91-188-9900", avatar: "YA", role: "supervisor" as const, performanceScore: 90, attendanceRate: 96,  joinedDate: "2025-09-05", assignedValves: ["valve-c"] as Prisma.InputJsonValue,                nationalId: "ETH-2347-G", dailyWage: 880, employmentType: "permanent", paymentMethod: "cash" },
    { id: "f-008", name: "Nuredin Hassen",   phone: "+251-91-199-0011", avatar: "NH", role: "manager" as const,    performanceScore: 96, attendanceRate: 100, joinedDate: "2025-09-01", assignedValves: ["valve-a","valve-b","valve-c"] as Prisma.InputJsonValue, nationalId: "ETH-2348-H", dailyWage: 1800, employmentType: "permanent", paymentMethod: "cash" },
  ];
  ...
  for (let d = 13; d >= 0; d--) {
    ...
    for (const [fi, f] of nonManagerFarmers.entries()) {
      ...
      const rec = {
        ...
        date: ds,
        status: st,
        // Each session marked separately; a normal day is the same both halves
        morningStatus: st,
        afternoonStatus: st,
