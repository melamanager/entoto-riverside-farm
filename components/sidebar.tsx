...
const NAV_GROUPS: NavGroup[] = [
  ...
  },
  {
    groupKey: "operations",
    items: [
      { href: "/routines",    labelKey: "routines",         icon: ClipboardCheck, roles: ["manager", "supervisor"] },
  ...
  },
  {
    ...
    items: [
      ...
      { href: "/connect",  labelKey: "connectTelegram", icon: MessageSquare, roles: ["manager", "supervisor"] },
