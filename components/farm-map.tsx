          ...
          <button key={m} onClick={() => setViewMode(m)}
            className={`text-[11px] px-3.5 py-1.5 rounded-full font-semibold transition-all shadow-sm ${
              viewMode === m
                ...
                : "bg-card text-stone-600 border border-stone-200 hover:border-stone-400 hover:shadow"
            }`}>
            ...
            <div className="p-4">
              <div className="flex items-start justify-between mb-3">
                ...
                <button onClick={() => setSelected(null)}
                  className="size-8 rounded-full bg-muted hover:bg-slate-200 flex items-center justify-center text-muted-foreground font-bold text-lg transition-colors">
                  ×
                </button>
              </div>
              ...
              <div className="grid grid-cols-4 gap-2 mb-3">
                {[
                  ...
                  <div key={label} className="bg-muted rounded-xl p-2.5 text-center border border-border/60">
